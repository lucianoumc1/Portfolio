...
const proyectsList = [
  {
    tittle: 'Chat App',
    description: "Aplicación web capaz de gestionar conversaciones entre distintos usuarios, al estilo de Whatsapp.",
    image: chatappImage,
  ...
  {
    tittle: 'Todo App',
    description: "Una aplicación para la gestión de tareas diarias. Creada con uso de JS, React, CSS y HTML.",
    image: todoappImage,
  ...
  {
    tittle: 'Simon Says',
    description: "El clásico juego de Simón dice construido como practica personal para reforzar conocimientos sobre callStack.",
